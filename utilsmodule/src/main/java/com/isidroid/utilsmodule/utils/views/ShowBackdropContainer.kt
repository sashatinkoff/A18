...
class ShowBackdropContainer @JvmOverloads internal constructor(
    ...
    override fun onClick(view: View) {
        ...
        val translateY = height - context.resources.getDimensionPixelSize(R.dimen.navigation_reveal_height)
